...
import de.hub.mse.emf.multifile.base.fuzz.JQFF;
...
public class ModelFuzzStatement extends Statement {
    ...
    public void evaluate() throws Throwable {
        ...
        try {
            ...
            ModelGenerationStatus genStatus = new ModelGenerationStatus();
            DocumentAwareGraphAwareGuidance guidance = (DocumentAwareGraphAwareGuidance) GuidedModelFuzzing.getCurrentGuidance();
    ...
    private ParameterTypeContext createParameterTypeContext(Parameter parameter) {
        ...
        return ParameterTypeContext.forClass(exec.getDeclaringClass());
        //  return new ParameterTypeContext(
        //          parameter.getName(),
        //          parameter.getAnnotatedType(),
        //          declarerName,
        //          typeVariables.entrySet().stream().findFirst().get().getValue())
